...
RCT_EXTERN_METHOD(addEvent:(NSString *)name startDate:(nonnull NSNumber *)starDate duration:(nonnull NSNumber *)duration description:(NSString *)description callback:(RCTResponseSenderBlock)callback)
